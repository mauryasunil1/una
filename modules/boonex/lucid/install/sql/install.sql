...
(@iCategoryId, CONCAT(@sName, '_page_width'), '_bx_lucid_stg_cpt_option_page_width', '1280', 'digit', '', '', '', 5),
...
('bx_lucid_page_width', @iMixId, '1280px'),
...
(3, @sName, '_bx_lucid', '_bx_lucid', 'bx_lucid@modules/boonex/lucid/|std-icon.svg');
